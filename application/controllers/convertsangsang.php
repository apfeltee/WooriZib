...
/**
	...
	delete from product_subway;
	delete from gallery;
	delete from products;

 **/
class Convertsangsang extends CI_Controller {
...
/* End of file convertsangsang.php */
/* Location: ./application/controllers/convertsangsang.php */
