		...
		<div>
			...
			<div class="band-wrapper padding-top-5 padding-bottom-5 text-center">
				...
				<div class="inline-block" style="width:230px;">
					<input type="text" id="search" name="search" placeholder="<?php echo lang("site.location");?>, <?php echo lang("site.subway");?>, <?php echo lang("product.no");?>, <?php echo lang("site.title");?>" class="form-control inline-block" autocomplete="off" style="width:150px;"/>
						...
						<form  action="/search/set_search/main" id="search_form" method="post">
							...
							<div id="search_tab">
								...
								<ul class="nav">
									...
									<li class="nav-two">
										<a href="#local_section"><?php echo lang("site.location");?></a>
									</li>
								...
								<div class="list-wrap">
									...
									<ul id="sybway_section" style='display:none;'>
									 ...
									 <ul id="google_section" style='display:none;'>
										<li>
											<input type="text" id="search" name="search" class="ui-autocomplete-input search_item" placeholder="<?php echo lang("site.location");?>, <?php echo lang("site.subway");?>, <?php echo lang("product.no");?>, <?php echo lang("product");?> <?php echo lang("site.title");?>" autocomplete="off" value="">
										</li>
									 </ul>
								 </div>
								<?php } ?>
