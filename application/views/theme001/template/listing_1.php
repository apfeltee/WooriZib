...
if(!$home_flag){
	if(count($product)<1){
		?>
		<tr>
			<td colspan="8"><h4>검색 결과가 없습니다.</h4>죄송합니다. 검색 조건에 맞는 검색 결과가 없습니다. <br/>그러나, 아직 등록되지 않은 <?php echo lang("product");?>(가)이 있으며 원하시는 조건의 <?php echo lang("product");?>을 찾아드릴 수 있으니 전화연락이나 매도/매수 문의를 이용하여 문의를 해주세요.</td>
		</tr>
		<?php
	}
}
