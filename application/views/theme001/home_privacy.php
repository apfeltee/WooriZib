<div class="main">
      <div class="_container">
		...
		<h2 class="padding-top-30">1 <small>수집하는 개인정보의 항목</small></h2>
		첫째, 회사는 회원가입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다.<br/>
		- 회원가입 시 필수항목 : 아이디(이메일), 비밀번호, 이름, 전화번호<br/><br/>
		...
		<h2 class="padding-top-30">2 <small>개인정보 수집방법</small></h2>
		...
		<h2 class="padding-top-30">3 <small>개인정보의 수집 및 이용목적</small></h2>

		①맞춤 <?php echo lang("product");?> 제공<br/>
		...
		<h2 class="padding-top-30">6 <small>개인정보 파기절차 및 방법</small></h2>
		...
		<h2 class="padding-top-30">7 <small>개인정보 자동 수집 장치의 설치/운영 및 거부에 관한 사항</small></h2>
		...
		<h2 class="padding-top-30">8 <small>개인정보의 기술적/관리적 보호 대책</small></h2>
		...
		<h2 class="padding-top-30">9 <small>개인정보관리책임자 및 담당자의 연락처</small></h2>

		①<?php echo $config->ceo?> <?php echo $config->mobile?><br/><br/>
		...
		<h2 class="padding-top-30">10 <small>고지의 의무</small></h2>
