					...
					<div role="tabpanel">
					  ...
					  <div class="tab-content" style="background-color:#FFF;">
						...
						<div class="form-group">
						  ...
						  <div class="col-lg-8">
							<input type="text" class="form-control" name="suPhone" autocomplete="off" placeholder="전화번호">
						  </div>
						</div>
						...
						<div class="row">
						  <div class="col-lg-8 col-md-offset-4 margin-bottom-10 text-right">
							<button type="submit" class="btn btn-primary"><?php echo lang("menu.signup");?></button>
						  </div>
						</div>
						<?php echo form_close();?>	
						</div>
