    ...
    <div class="row">
		...
		<div class="col-md-3 col-xs-12">
			...
			<div class="tab-content">
			  ...
			  ?>
			  <h4><?php echo $recent_title?> <?php echo lang("product");?> <i class="fa fa-question-circle help" data-toggle="tooltip" title="같은 종류의 <?php echo lang("product");?> 중 가까운 순으로 보여집니다."></i></h4>
			  <ul class="list_widget">
