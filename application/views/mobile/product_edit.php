...
<input type="hidden" id="current_danzi" value="<?php echo $query->danzi_id;?>"/>
...
<div class="page-content" id="main-stack">
  <div class="w-nav navbar" data-collapse="all" data-animation="over-left" data-duration="400" data-contain="1" data-easing="ease-out-quint" data-no-scroll="1">
    <div class="w-container">
      ...
      <div class="navbar-title"><?php echo lang("product");?><?php echo lang("site.modify");?></div>
  ...
  <div class="body">
	<?php echo form_open_multipart("member/product_edit_action/1","id='product_form' class='product form-horizontal'");?>
	<input type="hidden" name="id" value="<?php echo $query->id?>"/>
	<?php
		echo $product_form;
	?>
	<div class="text-center margin-top-20 margin-bottom-20">
		<button type="submit" class="btn btn-primary btn-lg" style="margin:20px;">수정</button>
	</div>
	<?php echo form_close();?>
  </div>
</div>
...
<div id="upload_dialog" title="<?php echo lang("site.imageupload");?>" style="display:none;padding:10px 0px 0px 0px;">
	<div style="padding:10px;">
		<?php echo form_open_multipart("product/upload_action","id='upload_form' autocomplete='off'");?>
