    ...
    <div class="page-content" id="main-stack">
      <div class="w-nav navbar" data-collapse="all" data-animation="over-left" data-duration="400" data-contain="1" data-easing="ease-out-quint" data-no-scroll="1">
        <div class="w-container">
          ...
          <div class="navbar-title"><?php echo lang("menu.uselaw");?></div>
        ...
        <div class="news-container item-new">
          <div>
            <div class="grey-header">
              <h2 class="grey-heading-title"><?php echo lang("menu.uselaw");?></h2>
            </div>
            <div class="text-new no-borders">
              <div>
                <div class="separator-fields"></div>
                <h2 class="title-new">제 1 조 <small>목적</small></h2>
                <div class="separator-fields"></div>
              ...
              <div>
                <h2 class="title-new">제 2 조 <small>정의</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 3 조 <small>약관의 게시와 개정</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 4 조 <small>약관의 해석</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 5 조 <small>이용계약 체결</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 6 조 <small>회원정보의 변경</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 7 조 <small>개인정보보호 의무</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 8 조 <small>"회원"의 "아이디" 및 "비밀번호"의 관리에 대한 의무</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 9 조 <small>"회원"에 대한 통지</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 10 조 <small>"회사"의 의무</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 11 조 <small>"회원"의 의무</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 12 조 <small>"서비스"의 제공 등</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 13 조 <small>"서비스"의 변경</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 14 조 <small>정보의 제공 및 광고의 게재</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 15 조 <small>"게시물"의 저작권</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 16 조 <small>"게시물"의 관리</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 17 조 <small>권리의 귀속</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 18 조 <small>계약해제, 해지 등</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 19 조 <small>이용제한 등</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 20 조 <small>책임제한</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
              ...
              <div>
                <h2 class="title-new">제 21 조 <small>준거법 및 재판관할</small></h2>
                <div class="separator-fields"></div>
				<p class="description-new">
