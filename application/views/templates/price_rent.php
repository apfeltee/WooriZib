...
<span style='border-radius:2px;color:white;padding:2px 6px 2px 2px;margin-right:2px;background-color:#209F4E;'><?php echo lang("product.price.rent")?></span>
...
if(isset($query["add_price"])){
	...
	<div style="display:block;">
		<span style='font-size:12px;border-radius:2px;color:white;2px 4px 2px 1px;margin-right:2px;background-color:#209F4E;'><?php echo cut_one(lang("product.price.rent"))?></span>
