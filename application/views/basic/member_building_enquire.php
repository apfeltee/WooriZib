        ...
        <div class="row margin-bottom-40">
			...
			<div class="col-md-12 col-sm-12">
				...
				<div class="margin-bottom-20">
					...
					<button type="button" class="btn btn-default" style="display:inline;margin-bottom:5px;" onclick="building_search(this)"><i class="glyphicon glyphicon-search"></i> 검색</button>
				</div>
				...
				<table class="border-table">
					...
					<tr>
						...
						<td width="30%" class="coverage_upper"></td>
						<th width="20%">용적율상한</th>
						<td width="30%" class="ratio_upper"></td>
					</tr>
					<tr>
						<th width="20%">건축면적상한</th>
						<td width="30%" class="building_area_uppper"></td>
						<th width="20%">지상연면적상한</th>
						<td width="30%" class="ground_total_floor_area"></td>
					</tr>
				</table>
				<h4>
