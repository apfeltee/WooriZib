...
$(document).ready(function() {
	...
	$("#upload_dialog").dialog({
			...
			buttons: {
				'<?php echo lang("site.register");?>': function() {
					$("#upload_form").submit();
				}
			}
	});
				...
				<div class="content-form-page">
					<?php echo form_open("/ask/add_action","id='ask_form' class='form-horizontal form-without-legend' role='form'");?>		
						...
						<div class="form-group">
						  <label class="col-lg-2 control-label"><?php echo lang("site.isopen");?> <span class="require">*</span></label>
							<div class="controls" style="padding-top:5px;padding-left:10px;">&nbsp;&nbsp;
								<label class="strip"><input type="radio" name="open" value="Y"/> <?php echo lang("site.open");?></label>
								<label class="strip"><input type="radio" name="open" value="N" checked="checked"/> <?php echo lang("site.private");?></label>
							</div>
						</div>
						...
						<div class="pull-right margin-top-10 margin-bottom-30">
							<?php if($config->ASK_TYPE){?>
							<button type="button" class="btn btn-default btn-lg" onclick="location.href='/ask/index'"><i class="icon-ok"></i> <?php echo lang("site.list");?></button>
							<?php }?>
							<button type="submit" class="btn btn-primary btn-lg"><i class="icon-ok"></i> <?php echo lang("site.register");?></button>
						</div>
						<script>
