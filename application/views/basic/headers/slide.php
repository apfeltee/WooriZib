        ...
        <div class="row" style="position:relative;">
            ...
            <div class="col-md-6 col-sm-6 col-xs-3">
                <ul class="list-unstyled list-inline">
					...
					<li><a href="#"><?php echo $config->mobile;?></a></li>
					<?php } else { ?>
                ...
                <ul id="myarea" class="list-unstyled list-inline pull-right">
					...
					<?php } else { ?>
						<?php if($config->MEMBER_JOIN){?>
							...
							<li><a href="/member/signup_pre">공인중개사 <?php echo lang('menu.signup');?></a></li>
							<?php } ?>
						<?php } ?>
						<li class="dropdown">
...
<div class="header">
  <div class="_container">
	...
	<?php if($config->DESIGN_LOGO_RIGHT!=""){?>
		<div class="call_box">
			<?php echo $config->DESIGN_LOGO_RIGHT;?>
		</div>
	<?php }?>
