	...
	<div class="main">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-9 col-sm-9">
            <h1><?php echo lang("site.saved");?></h1>
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20 text-right">
						<!--button type="submit" class="btn btn-primary">비교하기</button-->
                        <button type="submit" class="btn btn-danger" <?php echo (count($query)) ? "" : "disabled";?>><?php echo lang("site.delete");?></button>
                      </div>
                    </div>
					<?php echo form_close();?>
				</div>
