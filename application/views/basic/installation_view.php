    ...
    <div class="row">
		...
		<div class="col-md-3 col-xs-12">
			...
			<div class="tab-content">
			  ...
			  <h4><?php echo lang("site.recentinstallation");?> <i class="fa fa-question-circle help" data-toggle="tooltip" title="<?php echo lang("site.recentproducts_description");?>"></i></h4>
			  <ul class="list_widget">
