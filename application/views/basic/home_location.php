<div class="main">
      <div class="_container">
        <ul class="breadcrumb">
            ...
            <li class="active"><?php echo lang("menu.positionlaw");?></li>
        </ul>

		<div class="row margin-bottom-40">
		  <div class="col-md-12">
            <h1><?php echo lang("menu.positionlaw");?></h1>
            <div class="content-page">
				<div class="row">
					<div class="col-md-12">
		
		<h2 class="padding-top-30">1 <small>목적</small></h2>
		이 약관은 “<?php echo $config->name?>” 위치기반서비스(이하 "서비스"라 한다)를 이용하는 “고객” 사이의 “서비스” 이용에 관한 제반 사항을 정함을 목적으로 합니다.<br/>


		<h2 class="padding-top-30">2 <small>용어의 정의</small></h2>

		1) 이 약관에서 사용하는 용어의 의미는 다음 각 호와 같습니다. 아래 각 호에서 정의되지 않은 이 약관상의 용어의 의미는 “<?php echo $config->name?>” 이용약관 및 일반적인 거래 관행에 의합니다.<br/><br/>

		&nbsp;&nbsp;① “<?php echo $config->name?>”이란 “회사”가 제공하는 위치기반서비스입니다.<br/><br/>

		&nbsp;&nbsp;② “서비스”라 함은 이용자에게 스마트 폰 등의 위치정보를 기준으로 부동산 매물 등록 정보를 제공하는 것을 말합니다.<br/><br/>

		&nbsp;&nbsp;③ “고객”이라 함은 “<?php echo $config->name?>”을 이용하는 이용자를 말합니다.<br/><br/>

		&nbsp;&nbsp;④ “회원”이라 함은 회사에 개인정보를 제공하고 회원등록을 한 자로서, “<?php echo $config->name?>”의 정보를 지속적으로 제공받으며, “회사”가 제공하는 “<?php echo $config->name?>”의 “서비스”를 계속적으로 이용할 수 있는 자를 말합니다. “회사”는 “서비스”의 원활한 제공을 위해 “회원”의 등급을 “회사” 내부의 규정에 따라 나눌 수 있습니다.<br/><br/>
		...
		<h2 class="padding-top-30">3 <small>계약의 체결 및 해지</small></h2>
		...
		<h2 class="padding-top-30">4 <small>서비스의 내용</small></h2>
		...
		3) “회사”는 위치정보사업자인 이동통신사로부터 위치정보를 전달받아 “<?php echo $config->name?>”의 모바일 단말기 전용 어플리케이션(이하 "어플리케이션")을 통해 아래와 같은 위치기반서비스를 제공합니다.<br/><br/>
		...
		&nbsp;&nbsp;④ ”고객”의 위치 정보의 갱신은 “<?php echo $config->name?>” 실행 시 또는 실행 후, 위치 관련 메뉴 이용 시 이루어지며, “고객”이 갱신한 사용자의 위치정보를 기준으로 최종 위치를 반영합니다.<br/><br/>
		
		<h2 class="padding-top-30">5 <small>이용시간</small></h2>

		“<?php echo $config->name?>”의 이용은 24시간 가능하며, 다만, 시스템 장애, 프로그램 오류 보수, 외부요인 등 불가피한 경우에는 서비스 이용이 불가능 할 수 있습니다.<br/>
		
		<h2 class="padding-top-30">6 <small>위치정보수집 방법</small></h2>
		...
		<h2 class="padding-top-30">7 <small>접속자의 위치정보 이용</small></h2>
		...
		<h2 class="padding-top-30">8 <small>개인위치정보의 이용 또는 제공에 관한 동의</small></h2>
		...
		<h2 class="padding-top-30">9 <small>개인위치정보주체의 권리</small></h2>
		...
		<h2 class="padding-top-30">10 <small>"서비스"의 변경 및 중지</small></h2>
		...
		<h2 class="padding-top-30">11 <small>위치정보관리책임자의 지정</small></h2>
		...
		<h2 class="padding-top-30">12 <small>손해배상 및 면책</small></h2>
		...
		<h2 class="padding-top-30">13 <small>약관의 변경</small></h2>
		...
		<h2 class="padding-top-30">14 <small>분쟁의 조정</small></h2>
		...
		<h2 class="padding-top-30">15 <small>사업자 정보 및 위치정보관리책임자 지정</small></h2>

		1) “회사”의 상호, 주소, 전화번호 그 밖의 연락처는 다음과 같습니다.<br/><br/>

		&nbsp;&nbsp;상호 : <?php echo $config->name?><br/><br/>

		&nbsp;&nbsp;주소(도로) : <?php echo toeng($config->new_address)?><br/><br/>

		&nbsp;&nbsp;주소(지번) : <?php echo toeng($config->address)?><br/><br/>

		&nbsp;&nbsp;<?php echo lang("site.tel");?> : <?php echo $config->tel?><br/><br/>
		
		&nbsp;&nbsp;FAX : <?php echo $config->fax?><br/> <br/>

		2) 위치정보관리책임자는 다음과 같이 지정합니다.

		<h2 class="padding-top-30"><small>-개인정보 취급방침 및 위치정보관리책임자-</small></h2>

		&nbsp;&nbsp;성명 : <?php echo $config->ceo?><br/><br/>

		&nbsp;&nbsp;전자우편 : <?php echo $config->email?><br/><br/>
