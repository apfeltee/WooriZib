				...
				<table class="table table-bordered table-striped table-condensed flip-content margin-top-20">
					...
					<tbody>
						...
						<tr class="text-center">
							...
							<td>
							<?php if(element("status",$val)=="N"){echo "<span class=\"label label-danger\">대기</span>";}?>
							<?php if(element("status",$val)=="G"){echo "<span class=\"label label-primary\">진행</span>";}?>
							<?php if(element("status",$val)=="Y"){echo "<span class=\"label label-default\">완료</span>";}?>
							</td>
	...
	<div class="modal-dialog" style="max-width:275px;">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><?php echo lang("site.pw");?></h4>
		  </div>
			<div id="msg"></div>
