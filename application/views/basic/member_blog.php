        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-3">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              ...
              <li class="list-group-item clearfix"><a href="/member/product_add"><i class="fa fa-angle-right"></i> <?php echo lang("product");?> <?php echo lang("site.submit");?></a></li>
			  ...
			  <div class="row">
                <div class="col-md-12 col-sm-12">
					...
					<div class="text-right">
						<button onclick="blog_delete();" type="button" class="btn btn-danger" <?php if(count($query)<1) echo "disabled";?>>삭제</button>
						<button onclick="" type="button" class="btn btn-primary" data-toggle="modal" data-target="#blog_add_dialog"><?php echo lang("site.submit");?></button>
					</div>
				</div>
              </div>
            </div>
...
<div id="blog_edit_dialog" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" style="max-width:450px;">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="myModalLabel"><strong>블로그 수정</strong></h4>
			</div>
			<div class="modal-body">
				<div class="form-group">
					<label for="recipient-name" class="control-label"><strong>블로그</strong></label>
