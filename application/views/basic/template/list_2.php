<?php 
	...
	<div class='search-item'>
		...
		<div class='item'>
			<a href='/product/view/<?php echo $val["id"];?>' target="_blank"><h3><?php echo cut($val["title"],80);?></h3></a>
			<div class='address'><?php echo $val["address_name"];?></div>
