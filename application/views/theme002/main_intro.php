	<div class="main">
      <div class="_container">
        <ul class="breadcrumb">
            ...
            <li class="active"><?php if( $config->site_name!="" ) { echo $config->site_name; } else { echo $config->name; } ?> 소개</li>
        </ul>
		<div class="row margin-bottom-40">
		  <div class="col-md-12">
            <h1><?php if( $config->site_name!="" ) { echo $config->site_name; } else { echo $config->name; } ?> 소개</h1>
