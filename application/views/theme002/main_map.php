...
<div class="map_wrapper maplist_<?php echo $config->MAP_STYLE;?>">
	...
	<a href="#" class="pocp_button pocp_button_left btn_active pocp_button_reset btn-primary" onclick="search_reset()" style="background-color: #D54E21;"><i class="glyphicon glyphicon-refresh"></i> <?php echo lang("site.initfilter");?></a>
