...
<link href="/assets/theme002/css/theme002.css" rel="stylesheet">
<!--[if lt IE 9]>
...
<script src="/assets/plugin/jquery.banner.js"></script>
			...
			<div class="_container padding-top-40">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6">
						...
						<?php echo lang("site.fax");?>: <?php echo $config->biznum;?>
		...
		<div class="footer">
			<div class="_container">
				<div class="row">
					...
					<?php echo $config->year?> © <?php echo $config->name;?>. <?php echo lang("site.photo");?>, <?php echo lang("product");?>, <?php echo lang("menu.news");?> - <?php echo lang("msg.protected");?> 
					<?php echo anchor("main/intro",lang("menu.aboutus"));?> | 
					<?php echo anchor("home/rule",lang("menu.uselaw"));?> | 
					<?php echo anchor("home/privacy",lang("menu.infolaw"));?> | 
					<a href="/adminlogin/" target="_blank"><b><?php echo lang("menu.admin");?></b></a>
					</div>
					<div class="col-md-3 col-xs-12">
						<ul class="list-unstyled list-inline pull-right padding-top-10">
							...
							<li><a href="http://<?php echo $social->naver_blog;?>" target="_blank"><img src="/assets/common/img/icon_blog.png"></a></li>
							<?php } if(isset($social->facebook) && $social->facebook){?>
							<li><a href="http://<?php echo $social->facebook;?>" target="_blank"><img src="/assets/common/img/icon_facebook.png"></a></li>
							<?php } if(isset($social->twitter) && $social->twitter){?>
							<li><a href="http://<?php echo $social->twitter;?>" target="_blank"><img src="/assets/common/img/icon_twitter.png"></a></li>
							<?php } if(isset($social->google_plus) && $social->google_plus){?>
							<li><a href="http://<?php echo $social->google_plus;?>" target="_blank"><img src="/assets/common/img/icon_plus.png"></a></li>
