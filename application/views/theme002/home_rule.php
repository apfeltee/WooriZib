<div class="main">
      <div class="_container">
        <ul class="breadcrumb">
            ...
            <li class="active"><?php echo lang("menu.infolaw");?></li>
        </ul>

		<div class="row margin-bottom-40">
		  <div class="col-md-12">
            <h1><?php echo lang("menu.infolaw");?></h1>
            <div class="content-page">
				<div class="row">
					<div class="col-md-12">
		
		<h2 class="padding-top-30">제 1 조 <small>목적</small></h2>
		이 약관은 <?php echo $config->name?>(이하 "회사"라 함)(이)가 제공하는 <?php echo $config->name?> 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.


		<h2 class="padding-top-30">제 2 조 <small>정의</small></h2>

		이 약관에서 사용하는 용어의 정의는 다음과 같습니다.<br/>
		①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 <?php echo $config->name?> 및 <?php echo $config->name?> 관련 제반 서비스를 의미합니다.<br/>
		...
		<h2 class="padding-top-30">제 3 조 <small>약관의 게시와 개정</small></h2>
		...
		<h2 class="padding-top-30">제 4 조 <small>약관의 해석</small></h2>
		...
		<h2 class="padding-top-30">제 5 조 <small>이용계약 체결</small></h2>
		...
		<h2 class="padding-top-30">제 6 조 <small>회원정보의 변경</small></h2>
		...
		<h2 class="padding-top-30">제 7 조 <small>개인정보보호 의무</small></h2>
		...
		<h2 class="padding-top-30">제 8 조 <small>"회원"의 "아이디" 및 "비밀번호"의 관리에 대한 의무</small></h2>
		...
		<h2 class="padding-top-30">제 9 조 <small>"회원"에 대한 통지</small></h2>
		...
		<h2 class="padding-top-30">제 10 조 <small>"회사"의 의무</small></h2>
		...
		<h2 class="padding-top-30">제 11 조 <small>"회원"의 의무</small></h2>
		...
		<h2 class="padding-top-30">제 12 조 <small>"서비스"의 제공 등</small></h2>

		①회사는 회원에게 아래와 같은 서비스를 제공합니다.<br/>
		1.<?php echo lang("product");?> 등에 관한 정보제공 서비스<br/>
		2.<?php echo lang("product");?>에 대한 매도/매수 의뢰<br/>
		3.<?php echo lang("product");?>에 대한 추천<br/>
		...
		<h2 class="padding-top-30">제 13 조 <small>"서비스"의 변경</small></h2>
		...
		<h2 class="padding-top-30">제 14 조 <small>정보의 제공 및 광고의 게재</small></h2>
		...
		<h2 class="padding-top-30">제 15 조 <small>"게시물"의 저작권</small></h2>
		...
		<h2 class="padding-top-30">제 16 조 <small>"게시물"의 관리</small></h2>
		...
		<h2 class="padding-top-30">제 17 조 <small>권리의 귀속</small></h2>

		①"서비스"에 대한 저작권 및 지적재산권은 "회사"에 귀속됩니다. 단, "회원"의 "게시물" 및 제휴계약에 따라 제공된 저작물 등은 제외합니다.<br/>
		
		<h2 class="padding-top-30">제 18 조 <small>계약해제, 해지 등</small></h2>
		...
		<h2 class="padding-top-30">제 19 조 <small>이용제한 등</small></h2>
		...
		<h2 class="padding-top-30">제 20조 <small>책임제한</small></h2>
		...
		<h2 class="padding-top-30">제 21 조 <small>준거법 및 재판관할</small></h2>
