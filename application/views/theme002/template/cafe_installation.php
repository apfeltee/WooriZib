...
<?php if($member->type=="biz"){?>
	...
	<td style='padding-left:20px;'>
		...
		<?php echo lang("site.homepage");?>: <a href='http://<?php echo HOST?>/installation/view/<?php echo $query->id?>' target='_blank'>http://<?php echo HOST?>/installation/view/<?php echo $query->id?></a>
	</p></td>
<?php } else {?>
	<td style='border:0px;border-right:1px solid #cacaca;padding:10px;'>
