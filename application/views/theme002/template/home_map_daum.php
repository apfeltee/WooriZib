<style>
.clsBannerScreen {overflow: hidden;position: relative;height: 265px;width: 562px; border:1px solid #e1e1e1; cursor:pointer; clear:both;}
...
$(document).ready(function(){
	...
	$("#image_list_1").jQBanner({	//롤링을 할 영역의 ID 값
		nWidth:562,					//영역의 width
		nHeight:265,				//영역의 height
		nCount:5,					//돌아갈 이미지 개수
			...
			<div class="band-wrapper padding-top-5 padding-bottom-5 text-center">
				<div class="inline-block">
					...
					<?php foreach($category as $val){ ?>
						<li><span class="radiobox-wrap"><input type="checkbox" name="category[]" id="category_<?php echo $val->id;?>" value="<?php echo $val->id;?>" class='checkbox' ></span> <label for="category_<?php echo $val->id;?>"> <?php echo $val->name;?></label></li>
					<?php }?>
					</ul>
				</div>
				<div class="inline-block">
							...
							<div id="search_tab">
								...
								<div class="list-wrap">
									<ul id="google_section">
										<li>
											<input type="text" id="search" name="search" class="ui-autocomplete-input search_item" placeholder="<?php echo lang("site.address");?>, <?php echo lang("site.subway");?>, <?php echo lang("product");?> <?php echo lang("site.number");?>, <?php echo lang("product");?> <?php echo lang("site.title");?>" autocomplete="off" value="">
										</li>
									</ul>
...
<div>
	<div class="_container">
		<div class="row">
					...
					<div id="image_list_1">
						<div class="clsBannerScreen">
							<div class="images" style="display:block">
								<a href="/portfolio/"><img src="/assets/theme002/img/slide_1.png"></a>
							</div>
							<div class="images">
								<a href="/news/view/4"><img src="/assets/theme002/img/slide_2.png"></a>
							</div>
							<div class="images">
								<a href="/news/view/1"><img src="/assets/theme002/img/slide_3.png"></a>
							</div>
							<div class="images">
								<a href="/news/view/3"><img src="/assets/theme002/img/slide_4.png"></a>
							</div>
							<div class="images">
								<a href="/news/view/3"><img src="/assets/theme002/img/slide_5.png"></a>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6">
					<!-- http://hoonchul.com/test/imagemap/ -->
					<img src="/assets/theme002/img/middle_2.jpg" usemap="#imap_86">
					<map id="imap_86" name="imap_86" >
					  <area shape="rect" coords="0,0,318,118" alt="" title="" href="/news/view/4">
					  <area shape="rect" coords="3,125,155,265" alt="" title="" href="/news/view/3">
					  <area shape="rect" coords="163,124,316,264" alt="" title="" href="/news/view/1">
					  <area shape="rect" coords="325,0,570,264" alt="" title="" href="/news/view/2">
					</map>
				</div>
		</div>
	</div>
...
<div>
	<div class="_container" style="margin-top:20px;margin-bottom:20px;">
		<div class="row">
				<div class="col-lg-12">
					<a href="/portfolio/"><img src="/assets/theme002/img/middle3.jpg"></a>
				</div>
		</div>
	</div>
</div>