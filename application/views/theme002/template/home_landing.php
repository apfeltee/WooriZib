...
<div class="_container">
	...
	<?php }?>
	<?php if($code) {?>
		<div class="intro-lead-in"><?php echo $code;?></div>
	<?php }?>
					...
					<ul id="tab">
						...
						<li>
							<div class="row">
								...
								<div class="col-xs-5ths-2">
									<input type="text" id="search" class="form-control ui-autocomplete-input" placeholder="<?php echo lang("site.address");?>, <?php echo lang("site.subway");?>, <?php echo lang("product");?> <?php echo lang("site.number");?>, <?php echo lang("product");?> <?php echo lang("site.title");?>" autocomplete="off">
								</div>
								<div class="col-xs-5ths">
