...
function autoCompleteRenderAdmin(ul, item) {
	return $("<li class='search_rows'></li>").data("item.autocomplete", item).append("<i class='fa fa-user'></i> " + item.member_name).appendTo(ul);
}
...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-title">연락처 조회 통계</h3>
		<div class="page-bar">
	...
	<div class="col-md-12 col-xs-12">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
				<!-- BEGIN FORM-->
				<?php echo form_open("adminstats/call",Array("id"=>"list_form","class"=>"form-inline","method"=>"get"))?>
				<input type="hidden" name="member_id" id="member_id">
				<div class="input-group">
					<input type="text" class="form-control" name="member_name" id="member_name" placeholder="회원 검색" autocomplete="off" class="ui-autocomplete-input" value="<?php echo $this->input->get("member_name");?>">
				</div>
				<div class="input-group">
...
<div class="row">
	<div class="col-md-12 col-xs-12">
		...
		<table class="table table-bordered table-striped table-condensed flip-content">
			<thead>
				<tr>
					<th class="text-center" width="100px;"><?php echo lang("product.no");?></th>
					<th class="text-center"><?php echo lang("product");?>명</th>
					<th class="text-center">사용자정보</th>
					<th class="text-center" width="120px;"><?php echo lang("product.owner");?></th>
					<th class="text-center" width="140px;">일자</th>
				</tr>
			</thead>
			<tbody>
				<?php if(!$query){?>
				...
				<tr>
					...
					<td><a href="/product/view/<?php echo $value->product_id;?>" target="_blank" style="text-decoration:none;"><?php echo $value->title;?></a></td>
