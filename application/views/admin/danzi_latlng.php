...
<?php echo form_open("address/danzi_action","id='product_form'");?>
	<table class="table table-bordered table-striped table-condensed flip-content">
		...
		<tr>
			...
			<td>
				<input type="text" name="address" class="form-control" value="<?php echo $query->sido;?> <?php echo $query->gugun;?> <?php echo $query->dong;?> <?php echo $query->name;?>아파트"/>
			</td>
		</tr>
		<tr>
			<th width="15%">lat</th>
