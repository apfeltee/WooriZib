...
<script src="/script/product_add/admin"></script>
...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-title">
				<?php echo lang("product");?> 관리<small>등록</small>
		</h3>
		<div class="page-bar">
...
<?php echo form_open_multipart("adminproduct/add_action","id='product_form' class='product form-horizontal'");?>
...
<div class="text-center margin-top-20 margin-bottom-20">
	<button type="button" class="btn blue regist_btn btn-lg" is_activated="1" style="margin:20px;"><i class="fa fa-unlock"></i> 공개로 등록</button>
	<button type="button" class="btn red regist_btn btn-lg" is_activated="0" style="margin:20px;"><i class="fa fa-lock"></i> 비공개로 등록</button>
</div>
...
<div id="upload_dialog" title="<?php echo lang("site.imageupload");?>" style="display:none;">
	<?php echo form_open_multipart("adminproduct/upload_action","id='upload_form'");?>
