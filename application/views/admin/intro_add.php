...
<?php echo form_open_multipart("adminintro/add_action","id='intro_form'");?>
<div class="portlet">
	<div class="form-group">
		<div class="row">
			<div class="col-md-2">
				<label><strong>메뉴명</strong></label>
				<input type="text" class="form-control input-medium" name="title" placeholder="메뉴명" maxlength="10"/>
			</div>
			<div class="col-md-2">
