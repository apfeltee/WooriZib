...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-title">
				<?php echo lang("menu.notice");?><small><?php echo lang("site.register");?></small>
		</h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				<li><i class="fa fa-home"></i> <a href="/adminhome/index"><?php echo lang("menu.home");?></a> <i class="fa fa-angle-right"></i> </li>
				<li>
					<?php echo lang("menu.notice");?> <?php echo lang("site.register");?>
				</li>
			</ul>
...
<?php echo form_open_multipart("adminnotice/add_action","id='notice_form'");?>
<div class="portlet">
	...
	<div class="row static-info">
		...
		<div class="col-sm-10 col-xs-8 value">
			...
			<div style="width:540px;">
				<textarea name="content" class="form-control" rows="5" style="width:560px;"></textarea>
			</div>
		</div>
	</div>	
</div>
...
<div style="text-align:center;margin-top:10px;">
	<button type="submit" class="btn btn-primary"><?php echo lang("site.register");?></button>
</div>
<?php echo form_close();?>
