						...
						ent.removeClass('tp-ordered').removeClass('tp-layout');
						  setTimeout(function() {
							...
							if (opt.filterChangeAnimation=="fade") {
								TweenLite.to(ent,opt.filterChangeSpeed/1000,{opacity:0,scale:1,rotation:0});
								TweenLite.to(ent.find('.mega-entry-innerwrap'),opt.filterChangeSpeed/1000,{scale:1,opacity:1,transformPerspecitve:300,rotationX:0,ease:Power3.easeOut});										
							}
							else
							...
							if (opt.filterChangeAnimation=="rotate") {
								TweenLite.to(ent,opt.filterChangeSpeed/1000,{opacity:0,scale:1,rotation:rot});
								TweenLite.to(ent.find('.mega-entry-innerwrap'),opt.filterChangeSpeed/1000,{scale:1,opacity:1,transformPerspecitve:300,rotationX:0,ease:Power3.easeOut});										
							...
							if (opt.filterChangeAnimation=="rotatescale") {
								...
								TweenLite.to(ent,opt.filterChangeSpeed/1000,{opacity:0,scale:opt.filterChangeScale,rotation:rot,ease:Power3.easeOut});
								TweenLite.to(ent.find('.mega-entry-innerwrap'),opt.filterChangeSpeed/1000,{scale:1,opacity:1,transformPerspecitve:300,rotationX:0,ease:Power3.easeOut});										
							...
							if (opt.filterChangeAnimation=="pagetop" || opt.filterChangeAnimation=="pagebottom" || opt.filterChangeAnimation=="pagemiddle") {
								...
								TweenLite.to(ent,opt.filterChangeSpeed/1000,{opacity:0});
								TweenLite.to(ent.find('.mega-entry-innerwrap'),opt.filterChangeSpeed/1000,{scale:1,opacity:0,transformOrigin:torig,transformPerspecitve:1000,rotationX:90,ease:Power3.easeOut,overwrite:"all"});	
							}
	...
	function preparingLazyLoad(container) {
		...
		container.find('>.mega-entry').each(function(i) {
			...
			if (opt.filterChangeAnimation=="fade")
				...
				TweenLite.set(ent,{scale:1,opacity:0,rotation:0,transformPerspective:300,ease:Power3.easeOut});
			else
			if (opt.filterChangeAnimation=="scale") {

				TweenLite.set(ent,{scale:opt.filterChangeScale,opacity:0,rotation:0,transformPerspective:300,ease:Power3.easeOut});						
			}
			else
			if (opt.filterChangeAnimation=="rotate")

				TweenLite.set(ent,{scale:1,opacity:0,rotation:rot,transformPerspective:300,ease:Power3.easeOut});												
			else
			if (opt.filterChangeAnimation=="rotatescale") {

				TweenLite.set(ent,{scale:opt.filterChangeScale,opacity:0,rotation:rot,transformPerspective:300,ease:Power3.easeOut});																		
			}
			else
			if (opt.filterChangeAnimation=="pagetop" || opt.filterChangeAnimation=="pagebottom" || opt.filterChangeAnimation=="pagemiddle") {
					var torig = "center center";
					...
					TweenLite.set(ent,{opacity:0,transformPerspective:300,ease:Power3.easeOut});
					TweenLite.set(ent.find('.mega-entry-innerwrap'),{scale:1,opacity:0,transformOrigin:torig,rotationX:90,transformPerspective:1000,ease:Power3.easeOut});							
			}
	...
	function rePosition(container,maxdelay) {
		...
		container.find('>.mega-entry.tp-layout').each(function(i) {
			...
			if (ie) {				
				...
				if (w>219 && w<400) wproci="medium";
				if (w>399) wproci="large";
				
				if (h<220) wproci="small";
				if (h>219 && h<400 && (wproci=="small" || wproci=="medium")) wproci="medium";
				if (h>399 && wproci!="small") wproci="large";
				...
				if (firststart) {
						  ...
						  TweenLite.set(ent,{opacity:0,top:yp,left:xp,width:w,height:h,paddingBottom:pv,paddingRight:ph,ease:Power3.easeInOut,transformPerspective:300});
					}
					
				setTimeout(function() {
					TweenLite.to(ent,opt.filterChangeSpeed/1000,{scale:scal,opacity:opaa,rotation:rot,zIndex:1,width:w,height:h,top:yp,left:xp,paddingBottom:pv,paddingRight:ph,transformPerspective:300,ease:Power3.easeInOut});
					setTimeout(function() {

						TweenLite.to(ent.find('.mega-entry-innerwrap'),opt.filterChangeSpeed/1000,{scale:eiscal,opacity:eiopaa,rotationX:0, ease:Power3.easeInOut,transformPerspective:1000});
						ent.removeClass('mega-entry-added');
					},50);
					//TweenLite.set(iw,{backgroundPosition:'50% 49%', backgroundSize:'cover'});
				},timer_delay);
		...
		TweenLite.to(container,0.3,{height:maxhh,ease:Power3.easeOut,overwrite:"all"});
